...
Tags: widget, sidebar, rss, links, feed, button, subscribe, add to any, addtoany, add, any, email, e-mail, Google, My, Yahoo, Mixx, iTunes, Feeds
...
Sometimes you'll have to manually put it where you want it in your sidebar.  You can do so by going to `Presentation` > `Widgets` and dragging the widget onto the sidebar.  You'll need to have a "widget ready" theme.
