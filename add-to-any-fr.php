...
class Add_to_Any_Subscribe_Widget {
	...
	function display() {
		...
		?>
		<div style="text-align:center"><a href="http://www.addtoany.com/?sitename=<? bloginfo('name'); ?>&amp;siteurl=<? bloginfo('siteurl'); ?>&amp;linkname=<? $title; ?>&amp;linkurl=<? echo $feedurl; ?>&amp;type=feed"><img src="http://www.addtoany.com/add-sub.gif" width="91" height="17" border="0" title="Add to any service" alt="Add to any service"/></a></div>
		<?
	}
