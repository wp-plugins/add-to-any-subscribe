...
class Add_to_Any_Subscribe_Widget {
	...
	function display() {
		...
		?>
        <a name="a2a_dd" onmouseover="a2a_show_dropdown(this)" onmouseout="a2a_onMouseOut_delay()" href="http://www.addtoany.com/subscribe?linkname=<?=$sitename_enc?>&amp;linkurl=<?=$feedurl_enc?>"><?=$button?></a>
...
function A2A_SUBSCRIBE_options_page() {
    ...
    <p>
    	<label>
        	<input class="radio" type="radio"<?=$subscribe_16_16?> name="A2A_SUBSCRIBE_button" value="subscribe_16_16.png|16|16" />
    		<img src="<?=trailingslashit(get_option('siteurl')).PLUGINDIR.'/add-to-any-subscribe/subscribe_16_16.png'?>" width="16" height="16" border="0" />
		</label>
	</p>
    <p>
    	<label>
        	<input class="radio" type="radio"<?=$subscribe_120_16?> name="A2A_SUBSCRIBE_button" value="subscribe_120_16.gif|120|16" />
    		<img src="<?=trailingslashit(get_option('siteurl')).PLUGINDIR.'/add-to-any-subscribe/subscribe_120_16.gif'?>" width="120" height="16" border="0" />
		</label>
	</p>
    <p>
    	<label>
        	<input class="radio" type="radio"<?=$subscribe_171_16?> name="A2A_SUBSCRIBE_button" value="subscribe_171_16.gif|171|16" />
    		<img src="<?=trailingslashit(get_option('siteurl')).PLUGINDIR.'/add-to-any-subscribe/subscribe_171_16.gif'?>" width="171" height="16" border="0" />
		</label>
	</p>
    <p>
    	<label>
        	<input class="radio" type="radio"<?=$subscribe_256_24?> name="A2A_SUBSCRIBE_button" value="subscribe_256_24.gif|256|24" />
    		<img src="<?=trailingslashit(get_option('siteurl')).PLUGINDIR.'/add-to-any-subscribe/subscribe_256_24.gif'?>" width="256" height="24" border="0" />
		</label>
	</p>
    <p>
    	<label>
            <input name="A2A_SUBSCRIBE_hide_embeds" type="checkbox"<?=$subscribe_hide_embeds?>value="1"/>
            Hide embedded objects (Flash, video, etc.) when the menu is displayed
        </label>
	</p>
    <p>
        <label>
            <input name="A2A_SUBSCRIBE_show_title" type="checkbox"<?=$subscribe_show_title?>value="1"/>
